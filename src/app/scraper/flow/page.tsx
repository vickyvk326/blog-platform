          ...
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                {action === "getElementByXpath" && (
                  <>
                    <Input
                      ...
                      value={value || ""}
                      onChange={(e) =>
                        updateStep(idx, "getElementByXpath", e.target.value)
                      }
                    />
                    <p className="text-sm text-muted-foreground">
                      xpath of an element e.g.{" "}
                      <code>//div[@class="example&quot;]</code>
                    </p>
                  </>
                )}
                {action === "getElementsByXpath" && (
                  <>
                    <Input
                      placeholder="Xpath selector"
                      value={value || ""}
                ...
                {action === "getElementByCss" && (
                  <>
                    <Input
                      placeholder="CSS selector"
                      value={value || ""}
                      onChange={(e) =>
                        updateStep(idx, "getElementByCss", e.target.value)
                      }
                    />
                    <p className="text-sm text-muted-foreground">
                      CSS selector of an element e.g.{" "}
                      <code>.example-class</code>
                    </p>
                  </>
                )}
                {action === "getElementsByCss" && (
                  <>
                    <Input
                      placeholder="CSS selector"
                      value={value || ""}
                      onChange={(e) =>
                        updateStep(idx, "getElementsByCss", e.target.value)
                      }
                    />
                    <p className="text-sm text-muted-foreground">
                      CSS selector of group of elements e.g.{" "}
                      <code>.example-class</code>
                    </p>
                  </>
                )}
                ...
                {action === "extractAttribute" && (
                  <>
                    <Input
                      ...
                      value={value || ""}
                      onChange={(e) =>
                        updateStep(idx, "extractAttribute", e.target.value)
                      }
                    />
                    <p className="text-sm text-muted-foreground">
                ...
                {action === "waitForFullLoad" && (
                  <>
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Waits for given time to allow full page load (e.g. for
                ...
                {action === "executeJavaScript" && (
                  <>
                    <Input
                      ...
                      value={value || ""}
                      onChange={(e) =>
                        updateStep(idx, "executeJavaScript", e.target.value)
                      }
                    />
                    <p className="text-sm text-muted-foreground">
                ...
                {action === "inputText" && (
                  <>
                    <Input
                      ...
                      value={value || ""}
                      onChange={(e) =>
                        updateStep(idx, "inputText", e.target.value)
                      }
                    />
                    <p className="text-sm text-muted-foreground">
                      Inputs text into above selected element (should be input,
                      textarea or [contenteditable])
                    </p>
                  </>
                )}

                {action === "waitForXpathToDisappear" && (
                  <>
                    <Input
                      placeholder="Xpath selector"
                      value={value || ""}
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Waits until the xpath element disappears from page. E.g.
                      for loading indicators
                    </p>
                  </>
                )}

                {action === "waitForCssToDisappear" && (
                  <>
                    <Input
                      placeholder="CSS selector"
                      value={value || ""}
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Waits until the CSS element disappears from page. E.g. for
                      loading indicators
                    </p>
                  </>
                )}
